...
class MegaRandom extends StatefulWidget {
  const MegaRandom({Key? key}) : super(key: key);

  @override
  State<MegaRandom> createState() => _MegaRandomState();
}

class _MegaRandomState extends State<MegaRandom> {
        ...
        Expanded(
          child: Row(
            children: [
              ...
              ElevatedButton(
                  onPressed: () => {boolNormal = !boolNormal},
                  style: ElevatedButton.styleFrom(
                      primary: Colors.blue,
                      padding: const EdgeInsets.symmetric(
                          horizontal: 8, vertical: 5),
  ...
  initPhotoSelected() {
    ...
    setState(() {
      ...
      print ("= photoidSelected.length " +photoidSelected.length.toString());
    });
  }
